...
function App() {
        ...
        <Container id="harmonics">
            ...
            <Container className="text">
                <p>
                    ...
                    fundamental frequency) and always in the shape of sine
                    waves, no matter the waveform that produced the sound.
                    <br />
    ...
    const filterSection = (
        <Container id="filter">
            ...
            <h3>Low pass</h3>
            <p>
                The low pass filter removes high frequencies. Makes the sound
                darker and warmer.
            </p>
            <Player showFilter filterType="lowpass" showPartials showTypes />

            <h3>High pass</h3>
            <p>
                The high pass filter removes low frequencies. Makes the sound
                brighter and brilliant.
            </p>
            <Player showFilter filterType="highpass" showPartials showTypes />

            <h3>Band pass</h3>
            <p>
                The band pass filter is a combination of high and low filters.
                Makes the sound punchy.
            </p>
            <Player showFilter filterType="bandpass" showPartials showTypes />
        </Container>
    );
        ...
        <Container fixed id="envelope">
            ...
            <Container className="text">
                <p>
                    ...
                    <strong>Envelope generators</strong> allow users to control
                    the different stages of a sound.
                    <br />
                ...
                <h4>Attack </h4>
                <span>
                    The time taken for initial run-up of level from nil to peak,
                    beginning when the key is pressed.
                </span>

                <h5>Decay </h5>
                <span>
                    The time taken for the subsequent run down from the attack
                    level to the designated sustain level.
                </span>

                <h5>Sustain</h5>
                <span>
                    The level during the main sequence of the sound's duration,
                    until the key is released.
                </span>

                <h5>Release</h5>
                <span>
                    The time taken for the level to decay from the sustain level
